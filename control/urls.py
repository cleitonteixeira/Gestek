...
urlpatterns = [
    ...
    path('equipamento/<int:pk>/', views.detalhes_equipamento, name='detalhes_equipamento'),
    ...
    path('equipamento/<int:pk>/manutencao/', views.registrar_manutencao, name='registrar_manutencao'),
